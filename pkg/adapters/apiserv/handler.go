...
// curl -X POST -d '{"jsonrpc": "2.0", "method": "Scheduler.Set", "params":[{"corrID":"123","id":"bd954d5e-2b11-49a8-be81-2a53e25a9dc3", "executeAt":"2021-10-14T18:32:11+03:00","deadline":"2021-11-14T18:32:11+03:00","payload": {"type":"parse", "source": "example.com"}}], "id": "1"}' http://0.0.0.0:8000/rpc/v0
...
// curl -X POST -d '{"jsonrpc": "2.0", "method": "Scheduler.Get", "params":[{"id":"bd954d5e-2b11-49a8-be81-2a53e25a9dc3"}], "id": "1"}' http://0.0.0.0:8000/rpc/v0
...
// curl -X POST -d '{"jsonrpc": "2.0", "method": "Scheduler.Claim", "params":[{"amount":"3"}], "id": "1"}' http://0.0.0.0:8000/rpc/v0
...
// curl -X POST -d '{"jsonrpc": "2.0", "method": "Scheduler.Succeed", "params":[{"id":"bd954d5e-2b11-49a8-be81-2a53e25a9dc3","claimID":"f5dca270-be27-45aa-ae3a-6e5a600dd965","result": {"data": "job is done"}}], "id": "1"}' http://0.0.0.0:8000/rpc/v0
...
// curl -X POST -d '{"jsonrpc": "2.0", "method": "Scheduler.Fail", "params":[{"id":"bd954d5e-2b11-49a8-be81-2a53e25a9dc3","claimID":"09cd1033-2e13-4ff4-9e7d-35f4c58359ef","reason": "there was no one at home"}], "id": "1"}' http://0.0.0.0:8000/rpc/v0
